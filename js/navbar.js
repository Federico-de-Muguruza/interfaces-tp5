...
document.addEventListener("DOMContentLoaded", () => {
    let nav_dropdown_fuera = document.querySelector("#nav-dropdown-fuera")

    if (nav_dropdown_fuera) {
        nav_dropdown_fuera.addEventListener("click", function () {
